...
# modifying the buffer?". Is there a difference between the two, other than what operator 
...
# Yes. rolling_buffer1 alters the buffer input. rolling_buffer2 does not. 